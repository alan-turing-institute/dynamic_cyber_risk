---
title: "DISC breach inter-arrival times"
output: html_notebook
---

The notebook reproduces the predictions of CQAR and ARMA-GARCH for DISC breaches
...
ggplot(data = garch_long, aes(x = time, y = value, colour = variable)) +
  geom_line(size = 0.5) +
  scale_color_manual(
    labels = c(
      "actual",
