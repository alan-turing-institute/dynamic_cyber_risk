...
ggplot(data = cqar_long, aes(x = time, y = value, colour = variable, linetype = variable)) +
  geom_line(size = 0.8) +
  scale_color_manual(name="",
    labels = c(
      "actual",
...
ggplot(data = regret_long, aes(x = time, y = value, colour = variable, linetype = variable)) +
  geom_line(size = 1) +
  scale_color_manual(name="",
    labels = c(
      expression(paste(alpha, " = ", "0.90")),
  ...
  scale_linetype_manual(name="",
    ...
    values=c("twodash", "dotdash", "dotted")) +
  labs(
    title = "",
    x = "time",
    y = "average regret"
